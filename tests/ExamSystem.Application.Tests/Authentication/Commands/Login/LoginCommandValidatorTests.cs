...
namespace ExamSystem.Application.Tests.Authentication.Commands.Login
{
    public class LoginCommandValidatorTests
    {
        ...
        public void LoginCommandValidator_ShouldHaveError_ForInvalidInputs(string email, string password)
        {
            // Arrange
        ...
        [Fact]
        public void LoginCommandValidator_ShouldPass_When_CommandIsValid()
        {
            // Arrange
